...
export const VERSIONS = [1, 2, 3] as const;
...
export interface BrowserEventsV3 {
  cta_clicked: {
    cta_id: string;
    cta_text: string;
    cta_location?: string;
...
export interface ServerEventsV3 {
  lead_submitted: {
    form_id: string;
    lead_type: string;
    channel?: "direct" | "organic_search" | "paid_search" | "organic_social" | "paid_social" | "email" | "ai" | "referral" | "other_paid" | "unknown";
    utm_source?: string;
    utm_medium?: string;
    utm_campaign?: string;
    referring_domain?: string;
    heard_about?: "search_engine" | "social_media" | "recommendation" | "directory" | "press" | "event" | "returning_client" | "other";
  };
  lead_qualified: {
    lead_type: string;
    form_id: string;
...
export type BrowserEvents = BrowserEventsV3;
/** Server events at the current version. */
export type ServerEvents = ServerEventsV3;
...
export const BASELINE_DASHBOARDS: Readonly<Record<TaxonomyVersion, readonly DashboardInsight[]>> = {
  ...
  3: [
    ...
    {
      "key": "action.lead_submitted_by_channel",
      "stage": "action",
      "title": "`lead_submitted` by `channel`",
      "kind": "trend",
      "interval": "week",
      "series": [
        {
    ...
    {
      "key": "action.lead_submitted_by_heard_about",
      "stage": "action",
      "title": "`lead_submitted` by `heard_about`",
      "kind": "trend",
      "interval": "month",
      "series": [
        {
